  ...
  const reviews = [
    {
      ...
      location: "France 🇫🇷",
      review:
        "Excellente équipe! Ils ont transformé notre vision en réalité avec une expertise remarquable. Le résultat dépasse nos attentes.",
      rating: 5,
      language: "fr",
    },
    {
    ...
    },
    {
      ...
      location: "Germany 🇩🇪",
      review:
        "Hervorragende Arbeit! Die Zusammenarbeit war professionell und das Ergebnis übertrifft alle Erwartungen. Beste Entwickler mit denen wir je gearbeitet haben.",
      rating: 5,
      language: "de",
    },
    {

  ...
  const values = [
    {
      ...
      description:
        "We're committed to delivering innovative technology solutions that drive real business results and create lasting value.",
    },
    {
      icon: Zap,
      title: "Innovation First",
      description:
        "We stay ahead of technology trends and continuously adopt cutting-edge tools to give our clients a competitive advantage.",
    },
    {
      icon: Users,
      title: "Client-Centric",
      description:
        "Your success is our success. We work as an extension of your team, ensuring transparent communication and aligned goals.",
    },
    {
      icon: Award,
      title: "Quality Excellence",
      description:
        "We maintain the highest standards in code quality, security, and performance across all our projects and deliverables.",
    },
  ]
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Founded in 2020, we're a passionate team of developers, designers, and innovators dedicated to building the
            future through cutting-edge technology solutions.
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      ...
                      consultancy. We've helped over 100 companies transform their digital presence and achieve
                      unprecedented growth through innovative technology solutions.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      Our expertise spans across fullstack development, AI integration, cloud infrastructure, and
                      digital transformation strategies. We pride ourselves on staying at the forefront of technology
                      trends and delivering solutions that not only meet today's needs but anticipate tomorrow's
                      challenges.
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="text-center group hover:shadow-lg transition-all duration-300 border-0 shadow-md"
                >
        ...
        {/* Team Section */}
        <div>
          <h3 className="text-2xl md:text-3xl font-bold text-center text-foreground mb-12">Meet Our Team</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <Card
                key={index}
                className="text-center group hover:shadow-xl transition-all duration-300 animate-scale-on-hover border-0 shadow-lg"
              >
                <CardContent className="p-6">

  ...
  const projects = [
    {
      ...
      description:
        "Advanced e-commerce platform for premium gaming earbuds featuring software-based audio technology with ultra-low latency for gamers.",
    ...
    },
    {
      ...
      description:
        "Digital platform for Mohammed Bin Salman Foundation, empowering and connecting young leaders, innovators, and entrepreneurs globally.",
    ...
    },
    {
      ...
      description:
        "Modern construction company website showcasing projects, services, and career opportunities for a leading UAE-based contractor.",
    ...
    },
    {
      ...
      description:
        "Premium luxury jewelry e-commerce platform featuring natural diamonds, lab-grown diamonds, and customized jewelry with secure shopping experience.",
    ...
    },
    {
      ...
      description:
        "Mobile operations management application for El Race Contracting, streamlining construction project management and field operations.",
    ...
    },
    {
      ...
      description:
        "AI-powered mobile app that creates completely unique, personalized bedtime stories with custom characters, genres, and beautiful illustrations.",
    ...
    },
    {
      ...
      description:
        "AI-powered hair care app that analyzes your hair from a photo and creates personalized routines based on your unique hair type, porosity, and lifestyle.",
    ...
    },
    {
      ...
      description:
        "Emotional journaling app with AI-generated personalized responses, text-to-speech playback, and multiple AI personas for deeper self-awareness.",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Showcasing successful projects that have transformed businesses and delivered exceptional results across
            various industries.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="pt-0">
                ...
                <div className="mb-4 p-3 bg-success/10 rounded-lg border border-success/20">
                  <p className="text-sm font-medium text-success-foreground">📈 {project.results}</p>
                </div>
